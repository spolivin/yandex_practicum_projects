...
| [Startup Investments](https://github.com/spolivin/yandex_practicum_sql_project) | Writing queries of different levels of complexity to the database containing information about the venture capital and startup companies. | SQL/Postgres |
